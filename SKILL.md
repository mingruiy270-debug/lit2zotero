...
3. Search Europe PMC and Crossref; preserve source metadata and search boundaries. Use other installed academic-search tools as additional discovery sources, then confirm IDs before adding. Search conflicting evidence as well as support. Result rank is not an inclusion decision.
